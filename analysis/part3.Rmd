...
fig=plot_figure_all_code(data.frame(prop=round(unlist(yy),3),  plan=rep(c("hmo", "ffs"), length(diagnostic_code))), title="Diagnostic All CDT codes (all codes combined)", angle=0)
fig
