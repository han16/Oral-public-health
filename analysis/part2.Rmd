...
draw.pairwise.venn(area1=59361, area2=56763,cross.area=3694, 
                   category=c("HMO claims","FFS claims"),fill=c("lightblue","red")) # https://www.geeksforgeeks.org/how-to-create-a-venn-diagram-in-r/
...
calculate_time_period_hmo=function(X)
{
  ...
  if (nrow(id_visit)>1)
  {
    id_visit_rank=id_visit[rank(id_visit$FIRST_DATE_OF_SERVICE_converted),]
...
#saveRDS(t(time_preiod_visit_hmo), file="C:\\Shengtong\\Research\\OralPublicHealth\\Dental_Emergency_visit\\CWFluoridationAnalysis\\hmo_2019_time_period_visit_20240510.rds")
```
...
#saveRDS(t(time_preiod_visit_ffs), file="C:\\Shengtong\\Research\\OralPublicHealth\\Dental_Emergency_visit\\CWFluoridationAnalysis\\ffs_2019_time_period_visit_20240514.rds")
```


```{r, echo=F, message=F, warning=F}
hmo_2019_time_period_visit=readRDS("C:\\Shengtong\\Research\\OralPublicHealth\\Dental_Emergency_visit\\CWFluoridationAnalysis\\hmo_2019_time_period_visit_20240510.rds")
hmo_2019_time_period_visit1=data.frame(id=unlist(hmo_2019_time_period_visit[,1]), first_date_of_servie=unlist(hmo_2019_time_period_visit[,2]), last_date_of_service=unlist(hmo_2019_time_period_visit[,3]), time_period=abs(unlist(hmo_2019_time_period_visit[,4])))
```
...
```{r, echo=F, message=F, warning=F}
ffs_2019_time_period_visit=readRDS("C:\\Shengtong\\Research\\OralPublicHealth\\Dental_Emergency_visit\\CWFluoridationAnalysis\\ffs_2019_time_period_visit_20240514.rds")
ffs_2019_time_period_visit1=data.frame(id=unlist(ffs_2019_time_period_visit[,1]), first_date_of_servie=unlist(ffs_2019_time_period_visit[,2]), last_date_of_service=unlist(ffs_2019_time_period_visit[,3]), time_period=abs(unlist(ffs_2019_time_period_visit[,4])))
```
