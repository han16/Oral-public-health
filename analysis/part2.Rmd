...
demographics_2019=Demographics %>% filter(str_detect(EFFECTIVE_DATE, "2019"))
...
#length(unique(data_year2019$demographics_2019$RECIPIENT_ID)) # 827446
...
ggplot(data.frame(source=c( "Demographs", "HMO claims", "FFS claims"), num=c(827446, 56763, 59361)), aes(x=source, y=num, fill=source))+ 
...
* demographics: EFFECTIVE_DATE in 2019 


```{r, echo=F, message=F, warning=F}

#length(unique(intersect(data_year2019$demographics_2019$RECIPIENT_ID, data_year2019$ffs_claims_2019$RECIPIENT_ID))) # 32798
#length(unique(intersect(data_year2019$demographics_2019$RECIPIENT_ID, data_year2019$hmo_claims_2019$RECIPIENT_ID))) # 35116
#length(unique(intersect(data_year2019$hmo_claims_2019$RECIPIENT_ID, data_year2019$ffs_claims_2019$RECIPIENT_ID))) # 3694
#length(unique(intersect(intersect(data_year2019$demographics_2019$RECIPIENT_ID, data_year2019$ffs_claims_2019$RECIPIENT_ID),data_year2019$hmo_claims_2019$RECIPIENT_ID ))) # 2538
...
draw.triple.venn(area1=56763,area2=59361, area3 =827446,  
                 n12=3694, n23=32798, n13=35116, n123=2538,  
                 category=c("HMO","FFS","Demographics"), 
